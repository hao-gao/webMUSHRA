...
Volume2Page.prototype.render = function (_parent) {
  ...
  slider.append($("<p>Channel Count:"+this.audioContext.destination.channelCount+"</p>"));
  ...
  slider0.append(
    $('<tr></tr>').append(
      $('<td></td>').append(
        $('<button data-role="button" onclick="' + this.pageManager.getPageVariableName(this) + '.changeSw0(this.value)">Switch</button>'),
        $('<input type="range" name="slider"  min="0" max="100" value="'+ this.vol0*100 +'"  data-highlight="true" onchange = "' + this.pageManager.getPageVariableName(this) + '.changeVol0(this.value)">')
      )
    )
  );
  ...
  slider1.append(
    $('<tr></tr>').append(
      $('<td></td>').append(
        $('<button data-role="button" onclick="' + this.pageManager.getPageVariableName(this) + '.changeSw1(this.value)">Switch</button>'),
        $('<input type="range" name="slider"  min="0" max="100" value="'+ this.vol1*100 +'"  data-highlight="true" onchange = "' + this.pageManager.getPageVariableName(this) + '.changeVol1(this.value)">')
      )
    )
  );
  ...
  slider2.append(
    $('<tr></tr>').append(
      $('<td></td>').append(
        $('<button data-role="button" onclick="' + this.pageManager.getPageVariableName(this) + '.changeSw2(this.value)">Switch</button>'),
        $('<input type="range" name="slider"  min="0" max="100" value="'+ this.vol2*100 +'"  data-highlight="true" onchange = "' + this.pageManager.getPageVariableName(this) + '.changeVol2(this.value)">')
      )
    )
  );
  ...
  slider3.append(
    $('<tr></tr>').append(
      $('<td></td>').append(
        $('<button data-role="button" onclick="' + this.pageManager.getPageVariableName(this) + '.changeSw3(this.value)">Switch</button>'),
        $('<input type="range" name="slider"  min="0" max="100" value="'+ this.vol3*100 +'"  data-highlight="true" onchange = "' + this.pageManager.getPageVariableName(this) + '.changeVol3(this.value)">')
      )
    )
  );
