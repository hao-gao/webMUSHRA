...
function Mushra2Page(_pageManager, _audioContext, _bufferSize, _audioFileLoader, _session, _pageConfig, _mushraValidator, _errorHandler, _language) {
	this.isMushra = true; 
...
Mushra2Page.prototype.getName = function () {
  return this.pageConfig.name;
};

Mushra2Page.prototype.init = function () {
   var toDisable;
  var td;
  var active; 
  ...
  this.mushraAudioControl = new MushraAudioControl(this.audioContext, this.bufferSize, this.reference, this.conditions, this.errorHandler, this.pageConfig.createAnchor35, this.pageConfig.createAnchor70, this.pageConfig.randomize, this.pageConfig.createAnchor000, this.pageConfig.addReference);
...
Mushra2Page.prototype.render = function (_parent) {
  var div = $("<div></div>");
  _parent.append(div);
  var content; 
...
Mushra2Page.prototype.pause = function() {
    this.mushraAudioControl.pause();
};

Mushra2Page.prototype.setLoopStart = function() {
...
Mushra2Page.prototype.setLoopEnd = function() {
  var slider = document.getElementById('slider'); 
...
Mushra2Page.prototype.btnCallbackReference = function() {
...
Mushra2Page.prototype.btnCallbackCondition = function(_index) {
...
Mushra2Page.prototype.renderCanvas = function(_parentId) {
...
Mushra2Page.prototype.load = function () {
...
Mushra2Page.prototype.save = function () {
  this.macic.unbind(); 
...
Mushra2Page.prototype.store = function () {
